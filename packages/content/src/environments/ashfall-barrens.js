 ...
 */
export const ASHFALL_BARRENS = {
    id: 'ashfall_barrens',
    name: 'Ashfall Barrens',
    tagline: 'Black ground, white steam, and a wooden tub somebody keeps clean for no reason anyone can name.',
    inspiration: 'A young volcanic plateau in a cold maritime north — pumice flats, twisted survivor pines, a geothermal seep, and a footpath marked with painted stakes because there are no other landmarks.',
    ...
    arrival: {
        approach: 'A path of yellow-painted stakes across an entirely featureless black plain. You count them, because there is nothing else to do and because you want to know how many there are.',
        firstHeard: 'A hiss. Continuous, directionless, coming from the ground rather than from any particular place — and under it, very faint, water moving somewhere underneath you.',
        firstSeen: 'Steam, going straight up in three separate columns, lit from below by something orange that turns out to be the fire.',
        underfoot: 'Coarse black ash that squeaks and slides. Every footprint is perfect and stays perfect.',
        arrivalBeat: 'The last stake is right at the edge of the site and the ground changes to gravel and there is the fire, a wooden tub steaming beside it, and a single bent pine standing over both.',
        walkSeconds: { min: 36, max: 55 },
    },
    scene: {
        ground: 'volcanic-ash',
        groundNote: 'Coarse black-grey pumice grit, with rust-orange and sulphur-yellow mineral staining radiating out from every vent. Firelight on black ash goes almost nowhere, so the lit area is small and very defined.',
        vegetation: [
        ...
        elevation: 'gentle',
        elevationNote: 'Nearly flat with long low swells. The lack of relief is the point — this is a place where a single tree is a landmark.',
        water: {
            kind: 'hot-spring',
    ...
    weatherCharacter: {
        temperatureNote: 'Cold air over warm ground. Standing in the right place you are warm from below and cold from above at the same time, and finding those places is half the pleasure of the site.',
    ...
    fuel: {
        ...
        note: 'Anything left on the warm ground by a vent for an hour comes out drier than it went in, which is a genuinely useful trick and one the environment never explains. Birch bark from the tarp stack lights in a breath, even in rain.',
    },
    wildlife: [
        {
            id: 'arctic_hare',
    ...
    ambience: {
        ...
        waterPresence: 0.35,
        reverb: 'snowfield',
        reverbNote: 'Dead. Coarse ash absorbs like fresh snow and there is nothing to reflect off, so sound simply stops existing about ten metres out. The steam hiss fills the space that reverb would normally occupy.',
        distantEvents: [
    ...
    secrets: [
        {
            ...
            telling: 'A pencilled note under the bench lists dates and one-word conditions — CLEAN, ALGAE, CLEAN, FROZEN, CLEAN — going back years, in one handwriting, with no name.',
        ...
        },
        {
            ...
            telling: 'There is another one, out of sight of the rest, painted a different yellow and much older. Past it there is nothing at all, and the line does not continue.',
        ...
        },
        {
            ...
            telling: 'The steam columns collapse, the midges scatter, the reverb of the whole environment changes because the hiss that was masking everything is gone — and you discover you can hear the fire from thirty metres. Then it comes back on, all three at once.',
        ...
        },
        {
            ...
            telling: 'Wire, foil, a bottle cap, a small brass screw, and one item that belongs to your camp and was not missing.',
    ...
    machine: {
        ...
        flavourNote: 'Minerals from the steam have etched a permanent pale bloom across the machine’s windward panel, in a pattern like frost that never leaves. The unit sits on a bed of gravel someone levelled by hand, and the completion tone carries an absurd distance across the flats.',
...
//# sourceMappingURL=ashfall-barrens.js.map