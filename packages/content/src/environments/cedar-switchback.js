 ...
 */
export const CEDAR_SWITCHBACK = {
    id: 'cedar_switchback',
    name: 'Cedar Switchback',
    tagline: 'Trees like cathedral columns, a creek in a slot below, and an echo that takes its time.',
    inspiration: 'A temperate rainforest canyon on a wet coastal range — old-growth cedar, moss on everything, a trail of cut-log stairs, and a plank bridge over water you can hear from four hundred metres away.',
    ...
    arrival: {
        approach: 'Switchbacks cut into a slope so steep the trail has stairs made of split rounds pinned with rebar. Ferns at head height on the uphill side. It smells overwhelmingly green.',
        firstHeard: 'The creek, and then the creek again from a completely different direction, because the canyon is throwing it back at you.',
        firstSeen: 'A trunk. Just one, filling your entire view at three metres, with bark in vertical ribbons and moss growing on the moss.',
        underfoot: 'Wet duff and cedar stairs with chicken wire stapled to them for grip, half of it lifted.',
        arrivalBeat: 'The last switchback comes out onto a flat bench between two enormous cedars, and the fire is there, and the sound of the creek drops by half because the bench is out of the slot.',
        walkSeconds: { min: 38, max: 58 },
    },
    scene: {
        ground: 'moss-duff',
        groundNote: 'Deep red-brown cedar litter under a continuous moss carpet that climbs everything vertical it touches. Absolutely silent to walk on and permanently damp.',
        vegetation: [
        ...
        elevation: 'steep',
        elevationNote: 'Everything is on an angle except the bench, and the bench is flat because somebody cut it flat a long time ago. Above and below, the slope goes on out of sight.',
        water: {
            kind: 'creek',
    ...
    weatherCharacter: {
        temperatureNote: 'Mild and unchanging. The canopy is a lid: it is warmer here at 3am than it is a hundred metres up the slope, and you can feel that.',
        windNote: 'You never feel wind at the bench. You hear it in the canopy sixty metres up as a distant sea, entirely disconnected from the still air around the fire.',
        exposureNote: 'The most sheltered site in the catalogue after Cicada Bottoms, and the only one where heavy rain reaches the fire as an occasional large drop rather than as rain.',
    ...
    fuel: {
        ...
        note: 'Everything on the forest floor is wet. The stack inside the hollow cedar is the answer and it is the best-kept secret in the catalogue: a dry woodshed inside a living tree, restocked by nobody in particular. Cedar bark shredded off a trunk lights in one strike and smells like the entire coast.',
    },
    wildlife: [
        {
            id: 'varied_thrush',
    ...
    ambience: {
        ...
        waterPresence: 0.85,
        reverb: 'canyon',
        reverbNote: 'The best space in the product. The slot returns a hard first reflection at about 0.4 seconds and the far canyon wall gives a second at 1.6, so a shout comes back twice, distinctly. The two cedars add a close wooden warmth on top. Everything recorded here sounds expensive.',
        distantEvents: [
    ...
    secrets: [
        {
            ...
            telling: 'Dry ground, a stack of split maple, a shelf cut into the living wood, and eleven candle stubs on it in a row. The wood is stacked by somebody who intends to come back and never seems to.',
        ...
        },
        {
            ...
            telling: 'Dates, weather, and one line each. Everyone writes about the trees. One entry, in pencil, just says: "heard it twice tonight. same as last year." and nothing else, and there is no entry above it explaining what.',
            channels: ['notes'],
            oneTime: false,
            leavesEvidence: null,
            rarity: 0.4,
        ...
        },
        {
            ...
            telling: 'A four-note music-box figure with this creek audible behind it. Walk twenty metres off the bridge and it is gone. Nobody ever finds a transmitter, and the game never brings it up again.',
        ...
        },
        {
            ...
            telling: 'It is nailed to a tree ninety metres up the wrong side of the slope, pointing back at the bench, and there is nothing else up there at all.',
            channels: ['strange-objects', 'campsite-changes'],
            oneTime: true,
    ...
    machine: {
        ...
        flavourNote: 'Moss has started on the north side of this unit — a genuine green fuzz along the bottom of the panel that somebody scrapes off periodically and that always comes back. The compressor sounds enormous here because the canyon returns it.',
...
//# sourceMappingURL=cedar-switchback.js.map