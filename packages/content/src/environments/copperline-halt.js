...
export const COPPERLINE_HALT = {
    ...
    inspiration: 'A disused halt on a single-track branch line across dry scrub country — a name board, a lamp post with no lamp, a stock tank, and aspens that have grown in where the sidings used to be.',
    ...
    arrival: {
        approach: 'You walk in along the rails themselves, on the sleepers, because it is easier than the ballast and because everybody does. Ballast crunches, sleepers thud, and the spacing forces your stride into somebody else’s.',
        firstHeard: 'Wind through a signal gantry — a specific hollow whistle through a steel lattice, and under it a very faint radio, already playing, from the direction of the platform.',
        firstSeen: 'The name board. White letters on a dark ground, catching your light from a long way off, and unreadable until you are close.',
        underfoot: 'Ballast, then sleeper, then ballast, in a rhythm you cannot help matching. Then concrete.',
        arrivalBeat: 'The platform is a metre high, forty metres long, and completely empty. The fire is in a ring of ballast stones at the far end, the SM-01 is standing under the lamp post as if it is waiting for a train, and the radio somebody left on is still going.',
        walkSeconds: { min: 28, max: 46 },
    },
    scene: {
        ground: 'gravel-pad',
        groundNote: 'Grey angular ballast with weeds coming through it, going to compacted dust and cinders off the formation. The platform itself is cracked concrete with a worn yellow line still visible along the edge.',
        vegetation: [
        ...
        elevation: 'flat',
        elevationNote: 'Dead level, because a railway made it level. The formation is raised a metre above the surrounding scrub and that metre is the only topography for kilometres.',
        drawDistanceM: 150,
    ...
    weatherCharacter: {
        temperatureNote: 'Mild and dry, with the concrete and the rails giving back the day’s heat for hours. Sitting on the platform edge is warm long after the air is not.',
    ...
    ambience: {
        ...
        waterPresence: 0.04,
        reverb: 'clearing',
        reverbNote: 'Mostly open, with one hard flat return off the platform face and a completely different, tight, brick-and-plaster room the moment you step inside the hut. Walking in and out of the hut is an audible event.',
        distantEvents: [
    ...
    radio: {
        ...
        baseReception: 0.82,
        receptionNote: 'The best reception in the catalogue. A long-wire aerial already strung, kilometres of steel rail acting as a ground plane, no terrain, and no local noise floor whatsoever. Everything gets in.',
    ...
    secrets: [
        {
            ...
            telling: 'A tin of tea gone to dust, a candle, a paperback with the cover missing, and a notebook of shift entries — weather, work done, times — that stops mid-sentence on a page, with the pencil still in the fold.',
        ...
        },
        {
            ...
            telling: 'It is gone, and something else is there. A brass button. A ring pull. Once, a rail spike with a date stamped in the head that is older than the line.',
        ...
        },
        {
            ...
            telling: 'The carrier is carrying KCHL too, about four seconds late, from a room with someone in it. If you turn your radio off, the one in the carrier keeps playing. That is the whole of it and it is never explained.',
            channels: ['radio'],
            oneTime: false,
            leavesEvidence: null,
            rarity: 0.22,
        ...
        },
        {
            ...
            telling: 'It is a hurricane lantern, hung on the bracket, burning steadily, with a fresh wick and a full reservoir. Nobody is there. It burns all night and it is genuinely the warmest the environment ever looks.',
    ...
    machine: {
        ...
        flavourNote: 'Standing under a lamp post on a station platform, this unit looks more like railway equipment than catering equipment, and it has been treated as such: there is a chalked mark on the side in the same hand as the sleeper stack, and somebody has wired a spare fuse to the handle with copper wire in case it is ever needed. It never has been.',
...
//# sourceMappingURL=copperline-halt.js.map