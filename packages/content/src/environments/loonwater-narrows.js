 ...
 */
export const LOONWATER_NARROWS = {
    ...
    inspiration: 'A canoe-route campsite in northern lake country — glaciated granite, paper birch and black spruce, a fire grate someone bolted to the rock, and a portage sign nailed to a tree.',
    ...
    arrival: {
        approach: 'A portage trail through birch, root-crossed and worn to bare rock in places, with a canoe rest built from two poles between two trees at the halfway point. It comes out onto open granite without warning.',
        firstHeard: 'Water against rock — a small, irregular, endlessly varied lapping that never becomes a rhythm — and then, from a long way out, a loon.',
        firstSeen: 'The rock. Pale grey granite sloping down into black water, still holding the last of the day’s warmth and pale enough to walk on without a light.',
        underfoot: 'Roots, then bare rock, gritty with lichen and warm through your boots.',
        arrivalBeat: 'You come out onto the point and the lake opens on three sides at once. The fire is on the rock in an iron grate, low and orange, doubled exactly in water that is not moving at all.',
        walkSeconds: { min: 30, max: 48 },
    },
    scene: {
        ground: 'shield-rock',
        groundNote: 'Glacier-smoothed pink-grey granite with black lichen in patches and a seam of quartz running diagonally across the whole point. Duff and blueberry only where the rock dips.',
        vegetation: [
        ...
        elevation: 'bench',
        elevationNote: 'A gentle whaleback rising four metres from the water and dropping away behind into the birch. You are above the lake, which is why the sound carries the way it does.',
        water: {
            kind: 'lake',
            label: 'The narrows',
            widthM: 700,
    ...
    weatherCharacter: {
        temperatureNote: 'Cool, with the rock giving back heat under you and the lake pulling it out of the air above. Sitting on the granite is warm; standing up is not.',
        windNote: 'Comes down the length of the lake with a two-kilometre fetch and arrives with small waves in front of it. Behind the point it is completely still, and the water on the two sides of the point can look like different weather.',
    ...
    ambience: {
        ...
        waterPresence: 0.6,
        reverb: 'openForest',
        reverbNote: 'The distinctive one. Flat still water sends sound straight across and the far shore returns it two and a half seconds later, once, quietly and slightly darker. A single clap from the point comes back from the island as a soft slap you feel you should not have caused.',
        distantEvents: [
    ...
    secrets: [
        {
            ...
            telling: 'It is a campfire. It behaves exactly like a campfire, including going out. There is no campsite marked on the island and the portage sign lists no route to it. Nobody ever arrives from it or leaves it.',
        ...
        },
        {
            ...
            telling: 'Three metres down, on the white band, someone has stacked five stones into a small cairn, underwater, in a place where nobody could have stood. It is completely intact and it is furred with a decade of algae.',
        ...
        },
        {
            ...
            telling: 'Walk it and count. It is right. Then notice that a second, much older sign is nailed to the same tree behind it, face-in, and the number on that one is different by a hundred and forty rods — a portage to somewhere that is not on this route.',
        ...
        },
        {
            ...
            telling: 'It comes in. Right in — twenty metres off the rock, black and white and enormous, riding low, and it looks at you for a while. Then it dives, without a sound, and does not come up anywhere you can see.',
    ...
    machine: {
        ...
        flavourNote: 'This unit is bolted to the same granite as the fire grate, with the same generation of hardware, and the lichen has grown right up to the base plate and stopped in a clean line. The completion tone goes out across the narrows and comes back off the island two and a half seconds later, which regulars wait for.',
...
//# sourceMappingURL=loonwater-narrows.js.map