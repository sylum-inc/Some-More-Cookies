 ...
 */
export const MIRROR_FLATS = {
    id: 'mirror_flats',
    name: 'Mirror Flats',
    tagline: 'Two centimetres of water over a hundred square kilometres of salt, holding the whole sky upside down.',
    inspiration: 'A seasonally flooded salt pan in a continental desert basin — a boat ramp that has not touched water in decades, a picnic table on a gravel island, and a horizon with a visible curve to it.',
    ...
    arrival: {
        approach: 'A causeway of white gravel, one lane wide, running straight out into the flats with water on both sides that is nowhere deeper than your ankle. It goes on much further than you expect.',
        firstHeard: 'Your own footsteps, and their reflection off the water, which arrives a fraction late and makes it sound like someone is walking slightly out of step with you. That is all this is, and once you work it out it becomes companionable.',
        firstSeen: 'Stars. Below you. The water is holding the entire sky and the causeway appears to be floating in space.',
        underfoot: 'Salt-crusted gravel that crunches like frozen snow, then a centimetre of water that is exactly blood-warm.',
        arrivalBeat: 'The causeway ends at a gravel island about the size of a tennis court. A picnic table, a fire ring, the SM-01 — and their reflections, going down as far as they go up.',
        walkSeconds: { min: 40, max: 60 },
    },
    scene: {
        ground: 'salt-crust',
        groundNote: 'Polygonal salt crust, white going grey-violet at night, cracked into plates a metre across. Where it is flooded it is a perfect mirror; where it is dry it crunches.',
        vegetation: [
        ...
        elevation: 'flat',
        elevationNote: 'The flattest surface in the product. Any elevation change here is measured in centimetres and is visible for kilometres.',
        water: {
    ...
    weatherCharacter: {
        temperatureNote: 'Warm, even, and unmoving. The water holds the day’s heat and gives it back all night, so the temperature barely changes between arriving and leaving.',
        windNote: 'Almost none, and when it does come it arrives as a visible line crossing the mirror from kilometres away — you watch the reflection break, travel toward you, and reach you.',
    ...
    fuel: {
        ...
        note: 'Ancient shoreline driftwood is so dry and so salt-loaded that it lights instantly and burns with a pale, almost white flame with green at the edges. It is the strangest-looking fire in the catalogue and the fire reflected in the water beneath it doubles the effect exactly.',
    },
    wildlife: [
        {
            id: 'brine_fly',
    ...
    ambience: {
        ...
        waterPresence: 0.12,
        reverb: 'snowfield',
        reverbNote: 'Water over flat salt: sound gets one clean specular reflection off the surface and then nothing at all. Voices sound slightly doubled and slightly too close, which is exactly the intended feeling.',
        distantEvents: [
    ...
    secrets: [
        {
            ...
            telling: 'The lower marks are stained and worn. The second mark, forty centimetres up, is clean and unstained and has a date scratched beside it in the paint — a date the water has never come close to.',
        ...
        },
        {
            ...
            telling: 'A single line burned into the wood with a hot wire: a list of eleven dates in one hand, decades apart, the last one recent. No names. Someone comes back here.',
        ...
        },
        {
            ...
            telling: 'It is the right colour and the right size to be a campfire. Through binoculars it is still just a light. It is gone by dawn, it leaves nothing, and it is almost certainly a reflection of yours in a patch of water at exactly the wrong angle. Almost certainly.',
        ...
        },
        {
            ...
            telling: 'A laminated photograph of this ramp with a boat on it and water to the top of the concrete, and on the back, in ballpoint: "it was like this. I know."',
            channels: ['strange-objects', 'notes'],
            oneTime: true,
    ...
    machine: {
        ...
        flavourNote: 'Salt has crept up the machine’s feet and left a white tide line thirty centimetres up all four sides. The completion tone here has no reflections to interfere with it, so it is the purest the tone ever sounds — and it carries out over the water for what feels like a kilometre.',
...
//# sourceMappingURL=mirror-flats.js.map